  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        SwitchListTile(
          contentPadding: EdgeInsets.zero,
          title: Text(s.preferHttp2Fronting),
          subtitle: Text(s.preferHttp2FrontingHint, style: const TextStyle(fontSize: 11)),
          value: settings.preferHttp2Fronting,
          activeThumbColor: GuruTheme.sand,
          onChanged: (v) => settings.preferHttp2Fronting = v,
        ),
        const SizedBox(height: 6),
